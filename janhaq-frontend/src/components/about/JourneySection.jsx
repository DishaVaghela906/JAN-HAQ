...
export default function JourneySection() {
  return (
    <section
      id="journey"
      className="relative z-20 py-16 px-6 max-w-7xl mx-auto mt-8"
    >
      {/* Title Section */}
      <motion.div
      ...
      >
        <div className="inline-block bg-white/80 dark:bg-gray-900/60 backdrop-blur-md px-8 py-5 rounded-2xl shadow-md">
          ...
          <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
            From idea to functional platform in a rapid development cycle —
            driven by a passion for transparency.
          </p>
        </div>
      </motion.div>
        ...
        {journeySteps.map((step, index) => {
          ...
          return (
            ...
            >
              {/* Marker */}
              <div
                className="absolute hidden md:flex items-center justify-center w-10 h-10 rounded-full bg-sky-500 dark:bg-sky-400 z-10 top-1/2 transform -translate-y-1/2"
                style={{
                  left: isEven ? "50%" : "50%",
                  marginLeft: isEven ? "-20px" : "-20px",
                }}
              >
