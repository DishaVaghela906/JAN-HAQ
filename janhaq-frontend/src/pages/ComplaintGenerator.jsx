...
const ComplaintGenerator = () => {
    ...
    // --- NEW: Memoized retrieval of the currently selected department object (for officer details) ---
    ...
    const handleSubmitComplaint = async () => {
        ...
        // --- MANDATORY CHANGE: Use the memoized selectedDepartment instead of re-finding it ---
        if (!selectedDepartment) {
            return setError('Could not find department details. Please re-select the city and department.');
        }
                ...
                <div className="grid lg:grid-cols-2 gap-10">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-fit sticky top-24 border border-gray-200 dark:border-gray-700">
                        ...
                        <form onSubmit={handleGenerate} className="space-y-4">
                            ...
                            {/* --- NEW ADDITION: Officer Details Display --- *//*}
                            {selectedDepartment && (
                                <div className="p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
                                    ...
                                    <p className="text-sm">
                                        <strong>Name:</strong> {selectedDepartment.officerName || 'The Concerned Officer'}
                                    </p>
                                    <p className="text-sm">
                                        <strong>Role:</strong> {selectedDepartment.officerDesignation || `Head of ${selectedDepartment.name} Department`}
                                    </p>
                                    {selectedDepartment.officerEmail && (
                                        <p className="text-sm">
                                            <strong>Email:</strong> {selectedDepartment.officerEmail}
                                        </p>
                                    )}
                                </div>
                            )}
